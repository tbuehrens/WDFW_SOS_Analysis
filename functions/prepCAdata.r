...
prepCAdata<-function(mainDir, data_date, ESU_DPS_list,Recovery_Goals_LUT_edited, Recovery_Goals, POPFIT_exceptions,specialcaselistif,databeforelisting="No"){
  ...
  write.csv(dat,"raw_SPi_nosa_data.csv",row.names = F)
